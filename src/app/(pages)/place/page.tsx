...
const Local = () => {
  return (
    <div>
      <div className="flex flex-col-reverse sm:flex-row justify-center items-center text-center sm:text-left sm:justify-start gap-4">
        <Image src={fachada} alt="fachada" className="rounded-lg sm:w-1/2" />
